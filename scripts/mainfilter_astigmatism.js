...
import { material, mesh1, material1 } from "/elara-site-test.s3-website-us-east-1.amazonaws.com/scripts/astigmatism.js";
import { onWindowResize } from "/elara-site-test.s3-website-us-east-1.amazonaws.com/scripts/astigmatism.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/elara-site-test.s3-website-us-east-1.amazonaws.com/images/static_astigmatism.jpg');
