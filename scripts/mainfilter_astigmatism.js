...
import { material, mesh1, material1 } from "/scripts/astigmatism.js";
import { onWindowResize } from "/scripts/astigmatism.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/images/static_astigmatism.jpg');
