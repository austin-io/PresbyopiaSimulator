...
import {ablur, material, mesh } from "/PresbyopiaSimulator/scripts/strabismus.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/PresbyopiaSimulator/images/static_strabismus.jpg');
