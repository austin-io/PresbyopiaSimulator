...
import { material, mesh } from "/PresbyopiaSimulator/scripts/diabetic.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/PresbyopiaSimulator/images/static_diabetic.jpg');
