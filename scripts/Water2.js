...
class Water extends Mesh {
	...
	constructor( geometry, options = {} ) {
		...
		const normalMap0 = textureLoader.load( '/elara-site-test.s3-website-us-east-1.amazonaws.com/images/water_1.jpg' );
		const normalMap1 = textureLoader.load( '/elara-site-test.s3-website-us-east-1.amazonaws.com/images/water_2.jpg' );
		const mask = textureLoader.load( '/elara-site-test.s3-website-us-east-1.amazonaws.com/images/grad2.png' );
