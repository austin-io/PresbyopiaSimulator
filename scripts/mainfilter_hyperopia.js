...
import { material, mesh, scaleMesh } from "/PresbyopiaSimulator/scripts/hyperopia.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/PresbyopiaSimulator/images/static_myhypres.jpg');
