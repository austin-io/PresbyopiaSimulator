...
import { material, mesh, material1, controls } from "/PresbyopiaSimulator/scripts/AMDdry2.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/PresbyopiaSimulator/images/static_amddry.jpg');
