...
import { material, mesh } from "/elara-site-test.s3-website-us-east-1.amazonaws.com/scripts/glaucoma.js";
...
function cameraToggle() {
    ...
    if(camera) {
        var texture = new THREE.TextureLoader().load('/elara-site-test.s3-website-us-east-1.amazonaws.com/images/static_glaucoma.jpg');
